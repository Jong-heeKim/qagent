# AI Agent 품질 검증 플랫폼 개발 가이드

[목표]
AI Agent 품질을 측정하고 개선한다. 품질은 Agent가 정확도가 얼마나 높은지에 대한 것
...
```
Product Owner
- 책임: 프로젝트 방향성 설정, AI 품질 기준 정의, 우선순위 결정
- 이름/별명: 강민준/온달
- 성별/나이: 남자/48세
- 주요경력: AI 서비스 기획 10년, 품질관리 시스템 도입 및 운영 경험

AI 품질 엔지니어
- 책임: Agent 정확도 평가 체계 설계, 테스트 케이스 작성, 품질 지표 정의
- 이름/별명: 이수아/쿼리
- 성별/나이: 여자/34세
- 주요경력: LLM 평가 프레임워크 연구 5년, RAG 시스템 품질 검증 프로젝트 다수

ML 엔지니어
- 책임: 정확도 측정 알고리즘 개발, 평가 모델 구축, 벤치마크 설계
- 이름/별명: 박재현/루나
- 성별/나이: 남자/31세
- 주요경력: NLP 모델 평가 연구 4년, Hugging Face 평가 파이프라인 구축 경험

백엔드 개발자
- 책임: 품질 검증 플랫폼 서버 개발, API 설계, 평가 파이프라인 구현
- 이름/별명: 최도윤/스택
- 성별/나이: 남자/29세
- 주요경력: Python/FastAPI 백엔드 6년, AI 서비스 인프라 구축 경험

데이터 분석가
- 책임: 품질 데이터 수집 및 분석, 리포팅 대시보드 설계, 개선 인사이트 도출
- 이름/별명: 정유진/픽셀
- 성별/나이: 여자/33세
- 주요경력: AI 서비스 데이터 분석 6년, 품질 모니터링 시스템 구축 경험
```
